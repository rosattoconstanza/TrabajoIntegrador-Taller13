...
public class Scannear {
    ...
    //--------------------------------------------------------------------------------
    public static Grupo configurarGrupo(ArrayList<Seleccion> seleccionesDisponibles) {

        Scanner sc = new Scanner(System.in);
        System.out.println("Identificación del grupo:");
        ...
        Seleccion seleccion = seleccionesDisponibles.get(0);

        for (int i = 0; i < seleccionesDisponibles.size(); i++) {
            System.out.println(i + "-" + seleccionesDisponibles.get(i).getNombreFederacion());
        }
        for (int i = 0; i < 4; i++) {
            System.out.println("Seleccione una selección:");
            seleccion = seleccionesDisponibles.get(sc.nextInt());

            while (grupo.getSeleccion().contains(seleccion)) {
                System.out.println("Esta selección ya está agregada al grupo. Ingrese otra:");
                seleccion = seleccionesDisponibles.get(sc.nextInt());
            }
    ...
    //----------------------------------------------------------------------------------
    public static ArrayList<Fase> configurarFases(){
